...
resource_exists(ReqData, Context) ->
	Result = find_changes(wrq:path_info(timestamp, ReqData)),
	{true, ReqData, Context#context{changes=Result}}.
	
%% --------------------------------------------------------------------
%%% Internal functions
%% --------------------------------------------------------------------
find_changes(undefined) ->
	[];
find_changes(Timestamp) ->
	wurfler_update:find_changes(Timestamp).
%% --------------------------------------------------------------------
%%% Test functions
%% --------------------------------------------------------------------
